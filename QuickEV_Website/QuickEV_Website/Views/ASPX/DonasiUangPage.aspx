        ...
        <div class="DonatePage_RightContent">
            <div class="DonateForm_Container">
                <div class="Donate_Ammount1">
                    <asp:Button ID="Ammount_5000" runat="server" Text="IDR 5.000" CssClass="Ammount_5000" />
                    <asp:Button ID="Ammount_10000" runat="server" Text="IDR 10.000" CssClass="Ammount_10000" />
                    <asp:Button ID="Ammount_20000" runat="server" Text="IDR 20.000" CssClass="Ammount_20000"/>
                </div>
                <div class="Donate_Ammount2">
                    <asp:Button ID="Ammount_50000" runat="server" Text="IDR 50.000" CssClass="Ammount_50000" />
                    <asp:Button ID="Ammount_100000" runat="server" Text="IDR 100.000" CssClass="Ammount_100000" />
                </div>
                <div class="Donate_AmmountTxtBox">
                    <asp:TextBox ID="Donate_AmmountTxtBox" runat="server" Text="IDR     " placeholder="Masukin Nominal" CssClass="Donate_AmmountBox"></asp:TextBox>
                </div>
                ...
                <div class="DonateSubmit_Btn">
                    <asp:Button ID="Donate_Btn" runat="server" Text="Beri Donasi" CssClass="Donate_Btn" />
                </div>
