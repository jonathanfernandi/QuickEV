        ...
        <div class="container-page">
            <div class="form">
                ...
                <div class="emailBox">
                    ...
                    <asp:Label ID="emailErrorLbl" runat="server" Text="" ForeColor="Red"></asp:Label>
                </div>
                ...
                <div class="confPasswordBox">
                    ...
                    <asp:Label ID="confPasswordErrorLbl" runat="server" Text="" ForeColor="Red"></asp:Label>
                </div>
                ...
                <div class="genderBox">
                    ...
                    <asp:Label ID="genderErrorLbl" runat="server" Text="" ForeColor="Red"></asp:Label>
                </div>
                ...
                <div class="DOBBox">
                    ...
                    <asp:Label ID="DOBErrorLbl" runat="server" Text="" ForeColor="Red"></asp:Label>
                </div>
                ...
                <div class="daftarBox">
                    <asp:Button ID="daftarBtn" runat="server" Text="Daftar" CssClass="daftarBtn" OnClick="daftarBtn_Click" />
                </div>
            </div>
