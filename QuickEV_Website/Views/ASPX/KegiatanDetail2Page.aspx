<%@ Page Title="" Language="C#" MasterPageFile="~/Views/ASPX/sitemasternavbar.Master" AutoEventWireup="true" CodeBehind="KegiatanDetail2Page.aspx.cs" Inherits="QuickEV_Website.Views.ASPX.KegiatanDetail2Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <link href="../CSS/KegiatanDetail2Page_CSS.css" rel="stylesheet" />
        ...
        <div class="container">
            ...
            <div class="box1">
                ...
                <div class="box-info">
                    ...
                    <div class="box-gabung-button">
                        <asp:button ID="gabungBtn" Text="Gabung Relawan" CssClass="gabungBtn" runat="server" OnClick="gabungBtn_Click">
                        </asp:button>
                        <%--<asp:Label ID="gabungLbl" runat="server" Text="Anda telah bergabung." CssClass="gabungLbl" Visible="false"></asp:Label>--%>
                    </div>
